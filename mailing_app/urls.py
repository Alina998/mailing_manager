...
from .views import HomeView, ContactsView, MailingInfoView, RecipientInfoView, RecipientCreateView, RecipientUpdateView, RecipientDeleteView, LetterInfoView, LetterCreateView, LetterUpdateView, LetterDeleteView, MailingCreateView, MailingUpdateView, MailingDeleteView
